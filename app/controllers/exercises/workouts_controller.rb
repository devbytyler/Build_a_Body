class Exercises::WorkoutsController < ApplicationController
  ...
  before_action :set_exercise, only: [:show, :new, :edit, :create, :update, :destroy]
  ...
  def update
    respond_to do |format|
      if @workout.update(workout_params)
        format.html { redirect_to exercise_url(@workout.exercise_id), notice: 'Workout was successfully updated.' }
  ...
  private
    ...
    def workout_params
      params.require(:workout).permit(:date, :notes, :exercise_id, exercise_sets_attributes: [:id, :weight, :reps, :_destroy])
    end
end
